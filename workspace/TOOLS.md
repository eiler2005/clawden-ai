...
7. Только после этого синтезировать ответ; generic fallback без источников допустим лишь если после открытия кандидатов реально не найдено релевантного контента
8. Ответить в канал:
