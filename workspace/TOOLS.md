...
5. Только после этого синтезировать ответ; generic fallback без источников допустим лишь если после открытия кандидатов реально не найдено релевантного контента
6. Ответить в канал:
