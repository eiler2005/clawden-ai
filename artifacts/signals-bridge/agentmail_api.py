"""
Direct AgentMail HTTP client used by the signals bridge.
"""
...
class AgentMailApiClient:
    ...
    user_agent: str = "clawden-signals-bridge/1.0"
    ...
    def from_env(cls) -> "AgentMailApiClient":
        ...
        return cls(
            ...
            user_agent=os.environ.get("AGENTMAIL_API_USER_AGENT", "clawden-signals-bridge/1.0").strip()
            or "clawden-signals-bridge/1.0",
        )
    ...
    def list_messages(
        ...
        *,
        ...
        return self._request(
            "GET",
            f"/v0/inboxes/{urllib.parse.quote(inbox_id, safe='')}/messages",
            query={
                "limit": limit,
